...
function calculateMetrics() {
    ...
    for (let i = 0; i < mediaCount; i++) {
        ...
        const engagements = (data['좋아요 수'] || 0) + (data['댓글 수'] || 0); // 참여 = 좋아요 + 댓글
        ...
        } else if (!missingInputs['Reach1+']) missingInputs['Reach1+'] = ['도달 수', '노출 수'];
        ...
        <body>
            ...
            <ul>
                ...
                <li><strong>CPC</strong>
                    <div class="metric-box">
                        <p><strong>산출 공식:</strong> 광고 비용 ÷ 클릭 수</p>
                        <p><strong>설명:</strong> 클릭 1회당 비용입니다.</p>
                    </div>
                </li>
                <li><strong>CTR</strong>
                    <div class="metric-box">
                        <p><strong>산출 공식:</strong> (클릭 수 ÷ 노출 수) × 100</p>
                        <p><strong>설명:</strong> 노출 대비 클릭 비율입니다.</p>
                    </div>
                </li>
                <li><strong>CPA</strong>
                    <div class="metric-box">
                        <p><strong>산출 공식:</strong> 광고 비용 ÷ 전환 수</p>
                        <p><strong>설명:</strong> 전환 1건당 비용입니다.</p>
                    </div>
                </li>
                <li><strong>ROAS</strong>
                    <div class="metric-box">
                        <p><strong>산출 공식:</strong> (광고 매출 ÷ 광고 비용) × 100</p>
                        <p><strong>설명:</strong> 광고비 대비 매출 비율입니다.</p>
                    </div>
                </li>
                <li><strong>CPV</strong>
                    <div class="metric-box">
                        <p><strong>산출 공식:</strong> 광고 비용 ÷ 영상 조회 수</p>
                        <p><strong>설명:</strong> 영상 조회 1회당 비용입니다.</p>
                    </div>
                </li>
                <li><strong>VTR</strong>
                    <div class="metric-box">
                        <p><strong>산출 공식:</strong> (완료 시청 수 ÷ 노출 수) × 100</p>
                        <p><strong>설명:</strong> 영상 완료 시청 비율입니다.</p>
                    </div>
                </li>
                <li><strong>평균 빈도</strong>
                    <div class="metric-box">
                        <p><strong>산출 공식:</strong> 노출 수 ÷ 도달 수</p>
                        <p><strong>설명:</strong> 한 사용자당 평균 노출 횟수입니다.</p>
                    </div>
                </li>
                <li><strong>Reach1+</strong>
                    <div class="metric-box">
                        <p><strong>산출 공식:</strong> 도달 수</p>
                        <p><strong>설명:</strong> 1회 이상 노출된 고유 사용자 수입니다.</p>
                    </div>
                </li>
                <li><strong>Reach3+</strong>
                    <div class="metric-box">
                        <p><strong>산출 공식:</strong> 평균 빈도 ≥ 3일 때 근사치 계산</p>
                        <p><strong>설명:</strong> 3회 이상 노출된 고유 사용자 수입니다.</p>
                    </div>
                </li>
                <li><strong>GRP</strong>
                    <div class="metric-box">
                        <p><strong>산출 공식:</strong> (노출 수 ÷ 도달 수) × 100</p>
                        <p><strong>설명:</strong> 도달률과 빈도의 총합입니다.</p>
                    </div>
                </li>
                <li><strong>CPRP</strong>
                    <div class="metric-box">
                        <p><strong>산출 공식:</strong> 광고 비용 ÷ GRP</p>
                        <p><strong>설명:</strong> GRP 1점당 비용입니다.</p>
                    </div>
                </li>
                <li><strong>CPL</strong>
                    <div class="metric-box">
                        <p><strong>산출 공식:</strong> 광고 비용 ÷ 리드 수</p>
                        <p><strong>설명:</strong> 리드 1건당 비용입니다.</p>
                    </div>
                </li>
                <li><strong>CPE</strong>
                    <div class="metric-box">
                        <p><strong>산출 공식:</strong> 광고 비용 ÷ (좋아요 수 + 댓글 수)</p>
                        <p><strong>설명:</strong> 참여 1건당 비용입니다.</p>
                    </div>
                </li>
                <li><strong>CPS</strong>
                    <div class="metric-box">
                        <p><strong>산출 공식:</strong> 광고 비용 ÷ 공유 수</p>
                        <p><strong>설명:</strong> 공유 1건당 비용입니다.</p>
                    </div>
                </li>
            </ul>
        </body>
